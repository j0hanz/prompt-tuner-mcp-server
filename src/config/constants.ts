...
export const ANALYSIS_TIMEOUT_MS = LLM_TIMEOUT_MS;
export const REFINE_MAX_TOKENS = Math.min(LLM_MAX_TOKENS, 2000);
export const REFINE_TIMEOUT_MS = LLM_TIMEOUT_MS;
export const OPTIMIZE_MAX_TOKENS = Math.min(LLM_MAX_TOKENS, 3000);
export const OPTIMIZE_TIMEOUT_MS = LLM_TIMEOUT_MS;
export const VALIDATE_MAX_TOKENS = Math.min(LLM_MAX_TOKENS, 1000);
export const VALIDATE_TIMEOUT_MS = LLM_TIMEOUT_MS;
